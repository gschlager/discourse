...
\restrict rpMjxEK4taQXqqlA5qoz75dgnjI6qbpNRFTqUwPb5fmmqmZRGD4NcAx8r6swPEq
...
--
-- Name: phpbb_styles_imageset_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.phpbb_styles_imageset_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: phpbb_styles_imageset; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.phpbb_styles_imageset (
    imageset_id integer DEFAULT nextval('public.phpbb_styles_imageset_seq'::regclass) NOT NULL,
...
--
-- Name: phpbb_styles_imageset_data_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.phpbb_styles_imageset_data_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: phpbb_styles_imageset_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.phpbb_styles_imageset_data (
    image_id integer DEFAULT nextval('public.phpbb_styles_imageset_data_seq'::regclass) NOT NULL,
...
--
-- Name: phpbb_styles_template_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.phpbb_styles_template_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: phpbb_styles_template; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.phpbb_styles_template (
    template_id integer DEFAULT nextval('public.phpbb_styles_template_seq'::regclass) NOT NULL,
...
--
-- Name: phpbb_styles_template_data; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.phpbb_styles_template_data (
    template_id integer DEFAULT 0 NOT NULL,
...
--
-- Name: phpbb_styles_theme_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.phpbb_styles_theme_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: phpbb_styles_theme; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.phpbb_styles_theme (
    theme_id integer DEFAULT nextval('public.phpbb_styles_theme_seq'::regclass) NOT NULL,
...
--
-- Name: phpbb_styles_imageset_data phpbb_styles_imageset_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phpbb_styles_imageset_data
    ADD CONSTRAINT phpbb_styles_imageset_data_pkey PRIMARY KEY (image_id);


--
-- Name: phpbb_styles_imageset phpbb_styles_imageset_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phpbb_styles_imageset
...
--
-- Name: phpbb_styles_template phpbb_styles_template_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phpbb_styles_template
    ADD CONSTRAINT phpbb_styles_template_pkey PRIMARY KEY (template_id);


--
-- Name: phpbb_styles_theme phpbb_styles_theme_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.phpbb_styles_theme
...
--
-- Name: phpbb_posts_post_approved; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_posts_post_approved ON public.phpbb_posts USING btree (post_approved);
...
--
-- Name: phpbb_search_wordmatch_unq_mtch; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX phpbb_search_wordmatch_unq_mtch ON public.phpbb_search_wordmatch USING btree (word_id, post_id, title_match);
...
--
-- Name: phpbb_styles_imageset_data_i_d; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_styles_imageset_data_i_d ON public.phpbb_styles_imageset_data USING btree (imageset_id);


--
-- Name: phpbb_styles_imageset_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_styles_imageset_id ON public.phpbb_styles USING btree (imageset_id);


--
-- Name: phpbb_styles_imageset_imgset_nm; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX phpbb_styles_imageset_imgset_nm ON public.phpbb_styles_imageset USING btree (imageset_name);
...
--
-- Name: phpbb_styles_template_data_tfn; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_styles_template_data_tfn ON public.phpbb_styles_template_data USING btree (template_filename);


--
-- Name: phpbb_styles_template_data_tid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_styles_template_data_tid ON public.phpbb_styles_template_data USING btree (template_id);


--
-- Name: phpbb_styles_template_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_styles_template_id ON public.phpbb_styles USING btree (template_id);


--
-- Name: phpbb_styles_template_tmplte_nm; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX phpbb_styles_template_tmplte_nm ON public.phpbb_styles_template USING btree (template_name);


--
-- Name: phpbb_styles_theme_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_styles_theme_id ON public.phpbb_styles USING btree (theme_id);


--
-- Name: phpbb_styles_theme_theme_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX phpbb_styles_theme_theme_name ON public.phpbb_styles_theme USING btree (theme_name);
...
--
-- Name: phpbb_topics_forum_appr_last; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_topics_forum_appr_last ON public.phpbb_topics USING btree (forum_id, topic_approved, topic_last_post_id);
...
--
-- Name: phpbb_topics_topic_approved; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_topics_topic_approved ON public.phpbb_topics USING btree (topic_approved);
...
\unrestrict rpMjxEK4taQXqqlA5qoz75dgnjI6qbpNRFTqUwPb5fmmqmZRGD4NcAx8r6swPEq
