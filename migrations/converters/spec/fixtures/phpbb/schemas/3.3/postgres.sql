...
\restrict Z8ypjMKMNeTqLacgtMJ7JmOyacCaQkfzsZEbQBfdsvJo0tA2iNvS7OPYyZCYlUd
...
CREATE TABLE public.phpbb_bbcodes (
    ...
    bbcode_helpline character varying(4000) DEFAULT ''::character varying NOT NULL,
...
--
-- Name: phpbb_notification_emails; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.phpbb_oauth_states (
    ...
    state_time integer DEFAULT 0 NOT NULL,
    CONSTRAINT phpbb_oauth_states_state_time_check CHECK ((state_time >= 0)),
...
CREATE TABLE public.phpbb_profile_fields (
    ...
    field_validation character varying(128) DEFAULT ''::character varying NOT NULL,
...
CREATE TABLE public.phpbb_users (
    ...
    user_last_active integer DEFAULT 0 NOT NULL,
    ...
    user_actkey_expiration integer DEFAULT 0 NOT NULL,
    ...
    CONSTRAINT phpbb_users_user_actkey_expiration_check CHECK ((user_actkey_expiration >= 0)),
    ...
    CONSTRAINT phpbb_users_user_last_active_check CHECK ((user_last_active >= 0)),
...
--
-- Name: phpbb_notification_emails phpbb_notification_emails_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: phpbb_oauth_states_state_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phpbb_oauth_states_state_time ON public.phpbb_oauth_states USING btree (state_time);
...
--
-- Name: phpbb_users_user_email; Type: INDEX; Schema: public; Owner: -
--
...
\unrestrict Z8ypjMKMNeTqLacgtMJ7JmOyacCaQkfzsZEbQBfdsvJo0tA2iNvS7OPYyZCYlUd
